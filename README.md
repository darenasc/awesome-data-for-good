...
* [AI for Social Good, Using Artificial Intelligence to Save the World](https://www.wiley-vch.de/en/areas-interest/finance-economics-law/business-management-13ba/general-introductory-business-management-13ba0/business-technology-13ba03/ai-for-social-good-978-1-394-20578-3). Understand the real power of AI and and its ability to shape the future for the better. March 2024, 336 Pages.
...
* [DFx Viz Tool](https://data.undp.org/tools/viz-tool). This UNDP tool lets you transform numbers into compelling visual stories with ease and precision.
* [ES·pera](https://es-pera.org). ES·pera is an independent Spanish [public-data](https://es-pera.org/interanual/2025-12/datos.csv) project that integrates and normalises official public data on healthcare waiting lists and hospital activity, with national and regional coverage.
...
* [GeoHub](https://geohub.data.undp.org). UNDP GeoHub is a centralised ecosystem of geospatial services to support staff and development policy makers in the context of SDGs.
...
* [Roadmap to Social Impact](https://assets.csi.edu.au/assets/CSI-Roadmap-to-Social-Impact.pdf). Second edition. Your step-by-step guide to planning, measuring and communicating social impact.
* [SAFE AI Framework](https://www.cdacnetwork.org/resources/safe-ai-framework). Standards and Assurance Framework for Ethical AI in Humanitarian Action.
* [The AI Roadmap](https://www.datocms-assets.com/160835/1774623817-cht_report_theairoadmap.pdf). How We Ensure AI Serves Humanity.
